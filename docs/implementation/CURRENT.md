...
현재 배포의 공개 계약과 운영 DB는 v4 Canon 모델이다. PR #149의 runtime 커밋 `4eec38a345f5264ee50caebc6a080a2bf4dd2db6`가 main에 병합됐으며 Railway 배포는 확인 중이다. 이전 PR #148의 병합 커밋 `eabc4f2e86859d5fb1783fbbb55516953d0c63ab`는 web/API/worker 모두 SUCCESS로 확인했다. 새 v5 transaction·Revision reader·Clotho/Lachesis 인증·결정적 ID 경계는 내부 전용이며 live ingress에 연결되지 않았다. 역사 운영 World의 마지막 확인된 Revision은 30이다. IP-004~010 완료 이력은 유지한다.

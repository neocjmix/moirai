...
- Next.js와 Moirai의 현재 runtime 경계에 맞게 기술적으로 이식해야 하는 경우
...
복사된 SVG renderer, temporal-Y/free-X layout과 y-band spatial read를 보존하며,
정확한 의미와 stable identity는 Moirai query·sidecar·inspector가 소유한다.

...
| 활성 milestone             | [IP-003 — Canon 의미 재정렬](IP-003-canon-semantic-realignment.md) Slice 4                                                    |
| 현재 slice                 | Slice 4 — membership 기반 read·projection·publication·portability; Relation DP-001 open, M4.5-D/M5 비활성                   |

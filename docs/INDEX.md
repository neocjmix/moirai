...
- [IP-005 — Graph reader consolidation before M5 (complete, M5 inactive)](implementation/IP-005-graph-reader-consolidation.md)
...
- [IP-007 — Shared Event graph identity and Canon Narrative drawer (active, M5 inactive)](implementation/IP-007-shared-event-reader-identity.md)

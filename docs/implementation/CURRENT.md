...
| 현재 slice                 | M4.5-E Publication query composition 구현·검증; M5는 비활성                                                                 |
...
| M4.5-D2 완료               | PR #39 merge `b3677cf0fad03d9643c0f09784ae5295a7b926eb`; main CI `34615384373`, post-deploy `34615544535` success; [결정 기록](evidence/m45-d2-relations-diagnostics-implementation-2026-09-11.md) |
| M4.5-E 구현 중             | immutable Publication server composition, World Revision vector, actual identity/membership presentation, deterministic digest와 bounded partial failure; [결정 기록](evidence/m45-e-publication-composition-implementation-2026-09-11.md) |

...
현재 배포의 공개 계약과 운영 DB는 v4 Canon 모델이다. PR #154의 커밋 `de6dc8fc3778f07b21960ca019e861b2d312b11a`가 main에 병합됐고 Railway 배포가 진행 중이다. 이전 PR #153은 web/API/worker 배포 SUCCESS이며 운영 v4 DB는 변경되지 않았다. 새 v5 transaction·Revision reader·Clotho/Lachesis 인증·결정적 ID 경계는 내부 전용이며 live ingress에 연결되지 않았다. 역사 운영 World의 마지막 확인된 Revision은 30이다. IP-004~010 완료 이력은 유지한다.

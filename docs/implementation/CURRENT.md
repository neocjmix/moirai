...
현재 배포의 공개 계약과 운영 DB는 v4 Canon 모델이다. PR #183의 커밋 `c2d0ce1b027c2217db69b10a69701e2ea8855d98`까지 main에 병합됐고 CI run 36016129369이 성공했다. Railway web/API/worker도 해당 SHA에서 SUCCESS다. 운영 v4 DB는 변경되지 않았다. 새 v5 transaction·Revision reader·Clotho/Lachesis 인증·결정적 ID 경계는 내부 전용이며 live ingress에 연결되지 않았다. 역사 운영 World의 마지막 확인된 Revision은 30이다. IP-004~010 완료 이력은 유지한다.

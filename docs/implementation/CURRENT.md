...
현재 배포의 공개 계약과 운영 DB는 v4 Canon 모델이다. PR #150의 runtime 커밋 `8fc3cafe5625aa7c26d51f9c032e4ca079c9a47f`가 main에 병합됐고 web/API/worker 배포 SUCCESS를 확인했다. 새 v5 transaction·Revision reader·Clotho/Lachesis 인증·결정적 ID 경계는 내부 전용이며 live ingress에 연결되지 않았다. 역사 운영 World의 마지막 확인된 Revision은 30이다. IP-004~010 완료 이력은 유지한다.

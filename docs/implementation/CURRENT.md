...
| 현재 slice                 | M4.5-E immutable Publication query composition; M5는 비활성                                                                  |
...
| M4.5-E 구현 중             | Revision-fixed immutable Publication composition, World-scoped dedup/partial failure/digest/budget, production query smoke; [결정 기록](evidence/m45-e-publication-composition-implementation-2026-09-11.md) |

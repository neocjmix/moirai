...
| 현재 slice                 | M4.5-D2 R1 Relations/Diagnostics; M5는 비활성                                                                                |
...
| M4.5-D2 구현 중            | R1 shared/Canon-specific Relation, 전체 type filter, endpoint/time evidence, explanatory diagnostics; [결정 기록](evidence/m45-d2-relations-diagnostics-implementation-2026-09-11.md) |
